...
const Footer = () => {
  ...
  <footer className="bg-zinc-50  text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
    <div className="flex max max-w-6xl mx-auto items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
      <div className="me-12 ">
    ...
    <div className="py-10 px-4 max-w-6xl mx-auto text-center md:text-left">
