...
const Witchlist = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            ...
            try {
                const response = await axios.get(`process.env.NEXT_PUBSICT_URL/api/getwishlist?email=${email}`);
        ...
        <div className="max-w-6xl mx-auto px-4">
            <section className="pt-32 pb-10">
                <div className="p-5 rounded-md" style={{ boxShadow: '1px 1px 40px #149777' }}>
                    ...
                    <h2 className="text-2xl pb-5 font-semibold pl-5">My Product: {wishlist.length}</h2>
                                ...
                                <tbody>
                                    {wishlist.map(product => (
                                        <tr key={product._id}>
                                            ...
                                            <th>
                                                <Link href={`witchlist/${product._id}`}
